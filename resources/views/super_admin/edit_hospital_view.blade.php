    ...
    <div class="w-100" style="max-width: 900px;">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form action="{{ route('super_admin.hospital_edit', $data['id']) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="address_line"
                                      ...
                                      rows="2">{{ old('address_line', $data['address_line'] ?? '') }}</textarea>
                            @error('address_line')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="address_line2"
                                      ...
                                      rows="2">{{ old('address_line2', $data['address_line2'] ?? '') }}</textarea>
                            @error('address_line2')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
